...
export class GetBoardsTrelloForSelectImplementation
  implements GetBoardsTrelloForSelectRepository_I
{
  constructor(
  ...
  async fetch(props: {
    ...
    try {
      ...
      return await trello.getBoards({ memberId: props.memberId });
    } catch (error) {
      console.log(error);
