...
export interface CreateInsertLeadOnDemandAudienceRepository_I {
  create(props: PropsCreate): Promise<{ flowStateId: number }>;
  ...
  fetchFlow(filter: { accountId: number; _id: number }): Promise<null | {
    nodes: any;
    edges: any;
  }>;
  findFlowId(props: {
