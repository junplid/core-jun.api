import { GetFastMessageHumanServiceDTO_I } from "./DTO";
import { prisma } from "../../adapters/Prisma/client";
import { ErrorResponse } from "../../utils/ErrorResponse";

export class GetFastMessageHumanServiceUseCase {
  constructor() {}

  async run(dto: GetFastMessageHumanServiceDTO_I) {
    ...
    if (!fastMessage) {
      throw new ErrorResponse(400).toast({
        title: `Mensagem rápida não encontrada!`,
        type: "error",
      });
    }
