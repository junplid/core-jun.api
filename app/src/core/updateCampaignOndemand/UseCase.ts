import { UpdateCampaignOndemandDTO_I } from "./DTO";
import { prisma } from "../../adapters/Prisma/client";
import { ErrorResponse } from "../../utils/ErrorResponse";

export class UpdateCampaignOndemandUseCase {
  constructor() {}
  ...
  async run({
    ...
    try {
      const { CampaignOnBusiness, ...rest } = await prisma.campaign.update({
        where: { id },
        data: {
          ...dto,
          ...(status !== undefined && {
