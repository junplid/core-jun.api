...
import { NodeSendFileData } from "../Payload";
...
export const NodeSendAudio = (props: PropsNodeReply): Promise<void> =>
  new Promise(async (res, rej) => {
    ...
    const mimetype = mime.lookup(urlStatic);
    try {
      await SendAudio({
        connectionId: props.connectionWhatsId,
